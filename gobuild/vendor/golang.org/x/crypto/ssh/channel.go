...
const (
	...
	// Channel packets add SSH framing and padding on top of the channel payload.
	maxSupportedChannelMaxPacket = maxPacket - 32
)
...
func (c *channel) adjustWindow(adj uint32) error {
	...
	c.myConsumed += adj
	var sendAdj uint32
	if (c.mux.channelWindowSize-c.myWindow > 3*c.maxIncomingPayload) ||
		(c.myWindow < c.mux.channelWindowSize/2) {
...
func (ch *channel) Accept() (Channel, <-chan *Request, error) {
	...
	ch.maxIncomingPayload = ch.mux.channelMaxPacketSize
