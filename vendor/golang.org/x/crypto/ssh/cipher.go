...
const (
	...
	// the same. This fork raises the transport ceiling so a channel payload of
	// 256 kB can fit together with SSH framing and padding.
	// maxPacket is also used to ensure that uint32 length fields do not overflow,
	// so it should remain well below 4G.
	maxPacket = 512 * 1024
)
